...
void render()
{
	...
	glBegin(GL_QUADS);
		glTexCoord2f(0.0f, 0.0f); glVertex2f( -12.0f, 10.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex2f( 12.0f, 10.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex2f( 12.0f, -10.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex2f(-12.0f, -10.0f);
	glEnd();
